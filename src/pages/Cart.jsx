      ...
      <div className="w-full max-w-4xl p-10 pt-16 space-y-10 bg-[#D8D7D7]">
        ...
        <div className="space-y-20 mt-4 bg-[#D8D7D7] p-8 rounded">
          <div className="grid grid-row-2 grid-flow-col space-x-12 text-2xl text-center">
            <div>{cartData.car.make} {cartData.car.model} {cartData.car.year}</div>
            <div className="pl-2 py-8">{cartData.car.rentalCompany}</div>
            <div className="col-span-2 text-center px-6">
              <div>{cartData.car.pickupDate}</div>
              <div className="text-lg">to</div>
              <div>{cartData.car.returnDate}</div>
            </div>
            <div>{cartData.car.pickupLocation}</div>
            ...
            <div><span className="font-semibold">Rate:</span> {cartData.car.rateOption}</div>
          </div>
          <div className="text-2xl mt-4 grid grid-cols-2">
            <div className="font-semibold">Subtotal:</div>
            <div className="ml-[-180px]">{cartData.pricing.subtotal}</div>  
            <div className="font-semibold">Insurance Cost:</div>
            <div className="ml-[-180px]">{cartData.pricing.insuranceCost}</div>  
            <div className="font-semibold">Tax:</div>
            <div className="ml-[-180px]">{cartData.pricing.tax}</div>
            <div className="font-semibold">Total Due:</div>
            <div className="ml-[-180px]">{cartData.pricing.totalDue}</div>
          </div>
