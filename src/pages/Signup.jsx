    ...
    <div className="flex justify-center items-center min-h-screen bg-[#D8D7D7]">
      <div className="w-full max-w-2xl p-10 pt-16 space-y-10 bg-[#D8D7D7]">
        <div className="space-y-0">
          ...
          <p className="text-md text-[#040200] text-center">Please complete all fields below to create your account</p>
        </div>
        ...
        <p className="text-md text-center text-gray-600">
          Already have an account? <Link to="/login" className="text-[#5595AC] hover:underline">Log in here</Link>.
        </p>
      </div>
    </div>
  );
